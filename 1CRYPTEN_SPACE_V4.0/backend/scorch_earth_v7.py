...
async def scorched_earth_v7():
    logger.info("🔥 STARTING SCORCHED EARTH V7 - SNIPER SYSTEM RESET...")
    ...
    # 4. Initialize Core Docs (Single Trade Sniper Focused)
    logger.info("🏗️ Initializing Clean Core Documents for V7.0...")
    ...
    fs.collection("banca_status").document("status").set({
        ...
        "slots_disponiveis": 1,  # V7.0 strictly 1 trade
        "total_trades_cycle": 0,
    ...
    logger.info("🏁 V7.0 RESET COMPLETE. Sniper System is ready for ignition.")

if __name__ == "__main__":
    asyncio.run(scorched_earth_v7())
